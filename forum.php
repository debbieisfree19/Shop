    ...
    <div class="container">
        ...
        <section class="forum-header">
            <div style="display:flex;align-items:flex-start;gap:24px;margin-bottom:32px;">
                ...
                <p class="account-section-subtitle" style="margin:0;max-width:900px;">
                    ...
                    dành riêng cho cộng đồng yêu sách của Moonlit. Tại diễn đàn Moonlit, người đọc sách có thể thảo luận,
                    chia sẻ cảm nhận của bản thân nhằm lan tỏa cảm hứng đọc. Ngoài ra, khách hàng từng mua sách
                    tại Moonlit còn có thể tạo chủ đề mới để review và feedback về sản phẩm hoặc dịch vụ tại Moonlit.
                </p>
            </div>
        </section>
        ...
        <section class="forum-section">
            ...
            <p style="color:#666;margin-bottom:16px;">
                Nơi người đọc trao đổi cảm nhận, đánh giá và thảo luận về các tác phẩm văn học. Ngoài ra, khách hàng của Moonlit cũng có thể đăng tải các bài review về sản phẩm và dịch vụ tại Moonlit.
            </p>
