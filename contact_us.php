...
<a href="return-policy.php" class="header-menu-link <?=nav_active('return-policy.php',$currentPage)?>">Chính sách</a>
...
Tại đây, bạn có thể gửi mọi thắc mắc, góp ý hay yêu cầu hỗ trợ – Moonlit luôn sẵn sàng lắng nghe và tư vấn tận tình.
Hãy để Moonlit đồng hành cùng bạn và biến mỗi trải nghiệm đọc sách trở nên thú vị và đáng nhớ hơn.</p>
</div>
</section>
...
<div class="faq-item">
  ...
  <p>
    Sau khi bạn đặt hàng, Moonlit sẽ xử lý đơn hàng trong vòng 24 - 48 giờ làm việc. Thời gian giao hàng thường từ <strong>2 đến 5 ngày làm việc</strong>, tùy theo khu vực của bạn. 
    Chúng tôi sẽ gửi email xác nhận và mã theo dõi để bạn dễ dàng theo dõi trạng thái đơn hàng. Bạn có thể theo dõi chi tiết đơn hàng tại Mục Tài khoản. 
    Nếu có bất kỳ vấn đề gì về vận chuyển, đừng ngần ngại liên hệ với chúng tôi để được hỗ trợ nhanh chóng.
  </p>
</div>
...
<div class="faq-item">
  ...
  <p>
    Moonlit cung cấp nhiều phương thức thanh toán tiện lợi và an toàn để bạn lựa chọn. Bạn có thể thanh toán khi nhận hàng (<strong>COD</strong>), <strong>chuyển khoản ngân hàng</strong> hoặc qua các <strong>ví điện tử</strong> phổ biến. 
    Mọi giao dịch đều được mã hóa và bảo mật, giúp bạn yên tâm khi mua sắm. 
    Trong trường hợp gặp sự cố thanh toán, đội ngũ hỗ trợ của chúng tôi luôn sẵn sàng hướng dẫn và xử lý kịp thời.
  </p>
</div>
...
<div class="faq-item">
  ...
  <p>
    Moonlit cam kết mang đến trải nghiệm mua sắm thoải mái. Nếu sản phẩm bạn nhận được bị lỗi, hỏng hoặc không đúng mô tả, bạn có thể yêu cầu <strong>đổi trả trong vòng 7 ngày</strong> kể từ ngày nhận hàng. 
    Vui lòng giữ nguyên tình trạng sản phẩm, bao bì và liên hệ bộ phận chăm sóc khách hàng để được hướng dẫn các bước đổi trả nhanh chóng. 
...
<div class="faq-item">
  ...
  <p>
    Đội ngũ hỗ trợ Moonlit luôn sẵn sàng trả lời mọi thắc mắc của bạn qua email, hotline hoặc chat trực tiếp. 
    Chúng tôi cam kết phản hồi trong vòng <strong>24 giờ làm việc</strong>. 
    Dù là vấn đề về đơn hàng, sản phẩm hay gợi ý đọc sách, bạn đều có thể yên tâm rằng Moonlit sẽ đồng hành và giải đáp tận tình, đảm bảo sự hài lòng của khách hàng.
  </p>
</div>
...
<div class="faq-item">
  ...
  <p>
    ...
    Vì vậy, Moonlit đã tạo trang <strong>Blogs</strong> riêng nhằm cung cấp các kiến thức xoay quanh sách. Bạn có thể tìm kiếm thêm hướng dẫn bảo quản sách, mẹo giữ giấy tại trang này.
    Nếu cần, bạn cũng có thể yêu cầu tư vấn cá nhân bằng việc điền form ở trang Liên hệ với Moonlit phía trên.
  </p>
</div>
